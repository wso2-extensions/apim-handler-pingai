...
(https://wso2.com/api-management/)
    ...
    and then follow the [installation instructions for your platform](https://apim.docs.wso2.com/en/latest/InstallAndSetup/InstallationGuide/installation-prerequisites/).
