            ...
            if (aseConfigElement != null) {
                ...
                if (aseTokenElement != null) {
                    if (secretResolver.isInitialized()
                            && secretResolver.isTokenProtected("APIManager.AISecurityHandler.ASE.ASEToken")) {
                ...
                if (modelCreationEndpointElement != null) {
                    ...
                    if (accessKeyElement != null) {
                        if (secretResolver.isInitialized()
                                && secretResolver.isTokenProtected("APIManager.AISecurityHandler.ASE.AccessKey")) {
                            modelCreationEndpointConfig
                                    .setAccessKey(secretResolver.resolve("APIManager.AISecurityHandler.ASE.AccessKey"));
                        } else {
                    ...
                    if (secretKeyElement != null) {
                        if (secretResolver.isInitialized()
                                && secretResolver.isTokenProtected("APIManager.AISecurityHandler.ASE.SecretKey")) {
                            modelCreationEndpointConfig
                                    .setSecretKey(secretResolver.resolve("APIManager.AISecurityHandler.ASE.SecretKey"));
                        } else {
